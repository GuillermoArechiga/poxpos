...
export default function ShiftUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setStart_cash(cleanValues.start_cash);
    setCash_sale(cleanValues.cash_sale);
    setCard_sale(cleanValues.card_sale);
    setTotal_sale(cleanValues.total_sale);
    setIs_open(cleanValues.is_open);
    setErrors({});
  };
